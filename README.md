...
* [`Inférence_CLIP_Zero_Shot_(Base).ipynb`](./Inférence_CLIP_Zero_Shot_(Base).ipynb) : Évaluation initiale du modèle.
* [`Fine_Tuning_de_CLIP_(Apprentissage_Contrastif).ipynb`](./Fine_Tuning_de_CLIP_(Apprentissage_Contrastif).ipynb) : Pipeline d'entraînement et tests finaux.
